      ...
      >
        ...
        {/* 위젯 버튼들 */}
          ...
          >
            ...
            <span style={{ fontFamily: "'Do Hyeon', sans-serif", fontSize: '15px', color: showMore ? '#6366f1' : '#94a3b8' }}>
              더보기
            </span>
          </button>
      </div>
...
function BarButton({
  ...
  return (
    ...
    >
      ...
      <span style={{ fontFamily: "'Do Hyeon', sans-serif", fontSize: '15px', color: '#64748b', whiteSpace: 'nowrap' }}>
        {label}
      </span>
    </button>
  );
